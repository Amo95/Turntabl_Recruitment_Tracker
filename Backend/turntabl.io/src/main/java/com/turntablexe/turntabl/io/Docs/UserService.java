package com.turntablexe.turntabl.io.Docs;
...
import com.turntablexe.turntabl.io.service.EmailSenderService;
    ...
    public void sendVerificationEmail(String userMail, String verificationToken){
        ...
        mailMessage.setText(
                "Thank you for registering. Please click link the below to activate your account." +
                        ...
                        request.getServerPort()+"/api/turntablexe/register/confirm?token="
                        + verificationToken
        );
    ...
    public void resetPasswordMailToken(String userMail, String verificationToken){
        ...
        mailMessage.setText(
                ...
                "Click the link below to reset your password." + "http://"+request.getServerName()+":"+
                        request.getServerPort()+"/api/turntablexe/updatePassword?token="
                        + verificationToken +"&"+
                        "email="+userMail
        );

...
//
//    public void sendEmail(String email, String subject, String message)throws MessagingException, IOException {
//
...
//                "              <p style=\"font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px; color: black;\">" + message + "</p>\n" +
//                "              <p style=\"font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px; color: black;\"" + "</p>\n" +
//                "                  </td>\n" +
//                "                </tr>\n" +
//                "                </tbody>\n" +
//                "              </table>\n" +
